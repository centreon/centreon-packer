...
/usr/bin/systemctl status snmpd
/usr/bin/systemctl status snmptrapd
#/usr/bin/systemctl status ntpd
/usr/bin/systemctl status php-fpm
/usr/bin/systemctl status gorgoned
/usr/bin/systemctl status centreontrapd
/usr/bin/systemctl status cbd
/usr/bin/systemctl status centengine
/usr/bin/systemctl status centreon
